...
namespace ForcedDemo.Models
{
    public class BusinessLogic
    {
        ...
        {
            ApplicationDbContext db = new ApplicationDbContext();
            var appointments = from a in db.Appointments.Where(x => x.AccomodationPackageId == appointment.AccomodationPackageId)
                               select a;
        ...
        public static List<SelectListItem> AvailableAppointments(int docID, DateTime date)
        {
            ...
            var appointments = from a in db.Appointments.Where(x => x.AccomodationPackageId == docID)
                               select a;
            bool overlaps = false;
